...
const videoPopupTrigger = document.querySelectorAll(
    "a.section-reviews__item--video"
);

if (videoPopupTrigger.length) {
    videoPopupTrigger.forEach((trigger) => {
        trigger.addEventListener("click", (e) => {
            const videoLink = trigger.dataset.video;
            const modalReviewVideoFrame = document.querySelector(
                ".modal-review-video .youtube-player"
            );
